                    ...
                    <form action="{{ route('patents.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="patent_title" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full"
                                   value="{{ old('patent_title') }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="patent_number" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full"
                                   value="{{ old('patent_number') }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="inventors_name" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full"
                                   value="{{ old('inventors_name') }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="patent_status" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                <option value="Pending" {{ old('patent_status') == 'Pending' ? 'selected' : '' }}>Pending</option>
                                <option value="Granted" {{ old('patent_status') == 'Granted' ? 'selected' : '' }}>Granted</option>
                                <option value="Expired" {{ old('patent_status') == 'Expired' ? 'selected' : '' }}>Expired</option>
                            </select>
                        </div>

                        <div class="mb-4">
                            <label for="abstract" class="block text-gray-700">Abstract</label>
                            <textarea name="abstract" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>{{ old('abstract') }}</textarea>
                        </div>

                        <button type="submit" class="bg-gray-800 text-white font-bold py-2 px-4 rounded">Save</button>
                    </form>
